...
public class GuiMusicPlaylist extends BetterScreen {
	...
	public void extractRenderState(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		filterField.extractRenderState(guiGraphics, mouseX, mouseY, partialTicks);
		guiGraphics.text(font, info.u_team.music_player.gui.util.GuiTrackUtils.trimToWith(transferStatus, Math.max(20, width - 24)), 12, 56, 0xFFB8E986, false);
