...
public final class GuiTrackUtils {
	...
	public static void addTrackInfo(GuiGraphicsExtractor guiGraphics, IAudioTrack track, int x, int y, int entryWidth, int leftMargin, int titleColor) {
		...
		if (artwork) ArtworkRenderer.render(guiGraphics, track, x + leftMargin, y + 3, artworkSize);
		guiGraphics.text(MINECRAFT.font, title, x + textLeft, y + 4, titleColor, false);
		guiGraphics.text(MINECRAFT.font, author, x + textLeft + 3, y + 19, 0xFFD86D1C, false);
		guiGraphics.text(MINECRAFT.font, duration, x + entryWidth - 145, y + 12, 0xFFFFFF00, false);
	}
